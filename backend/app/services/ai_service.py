...
async def analyze_resume_text(text: str) -> dict:
    system_instruction = (
        ...
        "1. Extract factual fields perfectly.\n"
        "2. Evaluate the resume to generate category scores, strengths, and weaknesses.\n\n"
        "--- PART 1: EXTRACTION ---\n"
        ...
        "- Extract technologies hidden within project descriptions, work experience bullet points, certifications, and education sections.\n"
        "- STRICT CLASSIFICATION: Only classify entries under professional employment/internships as Work Experience. Extracurriculars, Activities, Leadership, Clubs, and Student Organizations MUST go under extracurricular_activities.\n"
        "- If there is no professional/paid work experience, return an empty work_experience array [].\n"
        "- Do NOT force every category to contain values. If something is genuinely absent in the text, return [].\n\n"
        "--- PART 2: EVALUATION ---\n"
        "- The following fields MUST ALWAYS BE GENERATED, even though they aren't explicitly written in the resume text.\n"
        "- YOU MUST ALWAYS populate 'category_scores' with realistic integer scores (0-100) based on the overall quality of the resume.\n"
        "- YOU MUST ALWAYS provide at least one generated string in 'strengths' and 'areas_for_improvement'.\n"
